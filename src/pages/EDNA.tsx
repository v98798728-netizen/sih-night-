          ...
          <div className="space-y-6">
            ...
            >
              ...
              <button 
                ...
                className="glass-ocean text-white px-4 py-2 rounded-md glow-hover transition-all duration-200"
              >
                Browse Files
              </button>
              <input
              ...
              {analysisComplete && (
                <div className="flex space-x-2">
                  <button 
                    ...
                    className="glass-ocean text-white px-4 py-2 rounded-lg glow-hover transition-all duration-200 flex items-center space-x-2"
                  >
                  ...
                  <button 
                    ...
                    className="glass-aqua text-white px-4 py-2 rounded-lg glow-hover transition-all duration-200 flex items-center space-x-2"
                  >
                      ...
                      return (
                        <div key={index} className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 bg-gray-200 rounded-full h-3">
                            <div 
                              className="bg-gradient-to-r from-ocean-500 to-aqua-500 h-3 rounded-full transition-all duration-500"
